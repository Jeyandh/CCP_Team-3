...
//			if (login != null) {
//				uId = login.getUser().getUserId(); // Store login_id
//				if (login.getPassword().equals(oldPassword)) {
//					if (newPassword.equals(confirmPassword)) {
//						PasswordManager passwordManager = passwordManagerService.findByUserId(uId);
...
//							} else {
//								passwordManager.setCreationDate(creation_time);
//								passwordManager.setExpirationDate(expiery_time);
...
//					else {
//						PasswordManagerDTO user = new PasswordManagerDTO();
//						user.setUser(uId);
//						user.setLastPassword1(newPassword);
//						passwordManagerService.saveOrUpdatePasswordManager(user);
//						login.setPassword(newPassword);
//						loginRepo.save(login);
//					}
					return "Record inserted";
