...
public class OptionResponseController {
	...
	@PutMapping("/updateResponse/{optionId}/{id}")
	public String performResponseById(@PathVariable long optionId, @PathVariable long id) {
		optionResponseService.updateReponseById(optionId,id);
