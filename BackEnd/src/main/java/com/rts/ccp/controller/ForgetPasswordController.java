...
public class ForgetPasswordController {
	...
	public ResponseEntity<Response> verifyOTP(@RequestParam Map<String, String> requestParams) {
	...
	public ResponseEntity<Response> updatePassword(@RequestParam Map<String, String> requestParams) {
